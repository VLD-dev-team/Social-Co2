...
class LeaderBoardWidget extends StatefulWidget {
  ...
  const LeaderBoardWidget({Key? key, required this.indexAffichage})
      : super(
            key:
                key); //on indique que la variable indexAffichage est requise pour construire le widget
...
class _LeaderBoardWidgetState extends State<LeaderBoardWidget> {
  String selectedIcon =
      'world'; //On crée une variable pour afficher le classement monde ou des amis en la mettant sur monde par défaut

  @override
  Widget build(BuildContext context) {
    switch (widget.indexAffichage) {
      //en fonnction de la valeur de indexAffichage, fournie à l'appel du widget, on renverra le widget correspondant
      case 1:
  ...
  Widget buildAffichagePourIndex1() {
    ...
    return Container(
      ...
      child: Column(
        //On déclare un format colmun pour pouvoir mettre plusieurs widget les uns sur les autres
        crossAxisAlignment:
            CrossAxisAlignment.center, //On centre les widgets dans la colonne
        children: [
          const SizedBox(
          ...
          SizedBox(
            ...
            child: Card(
              ...
              child:
                ...
                GestureDetector(
                  //permet de detecter quand l'utilisateur clic sur l'icone monde
                  onTap: () {
                    setState(() {
                      selectedIcon =
                          'world'; //Dans ce cas on donne la valeur world au selectedIcon
                    });
                  },
                  child: Container(
                    padding: const EdgeInsets.all(
                        2), // Ajoute de l'espace autour de l'icône
                    decoration: BoxDecoration(
                      color: selectedIcon == 'world'
                ...
                GestureDetector(
                  //permet de detecter quand l'utilisateur clic sur l'icone amis
                  onTap: () {
                    setState(() {
                      selectedIcon =
                          'friends'; //Dans ce cas on donne la valeur friends au selectedIcon
                    });
                  },
                  child: Container(
                    padding: const EdgeInsets.all(
                ...
                const Card(
                    child: Padding(
                      ...
                      child: Text(
                        "Monde",
                        style: TextStyle(fontSize: 25),
                      ), //si elle est vraie on affiche World
                    ),
                  )
                : const Card(
                    child: Padding(
                      ...
                      child: Text(
                        "Amis",
                        style: TextStyle(fontSize: 25),
                      ), //Sinon on affiche Amis
                    ),
                  ),
          ),
          Consumer<LeaderBoardProvider>(
              //permet d'importer les données que nous fourni le provider
              builder: ((context, value, child) {
            if (value.isLoading) {
              //affichage du charment
              ...
              if (value.error == "") {
                //s'il n'y a pas d'erreur on affiche la liste (le classement)
                return SizedBox(
                  height: 420,
                        ...
                        return Container(
                          ...
                          child: Card(
                            child: Container(
                              ...
                              child: ListTile(
                                //le widget ListTile décrit la construction d'une ligne de la liste, et se répéte le nombre d'itemCount
                                leading: CircleAvatar(
                                  //Affiche un rond qui contient le classement
                                  backgroundColor: Colors.white,
                                  child: Text(
                                    '${index + 1}e', //classement
                                    style: TextStyle(
                                        fontSize: 20,
                                        color: index == 0
                                ...
                                title: Row(
                                  children: [
                                    SizedBox(
                                      ...
                                      height: 40,
                                      child: CircleAvatar(
                                        //affiche photo de profil utilisateur
                                        ...
                                        backgroundImage: selectedIcon ==
                                            ...
                                            ? (value.leaderBoardFriends
                                                        ...
                                                        ["PhotoURL"] !=
                                                    null
                                                ? //condition si l'utilisateur n'a pas de photo de profil, et qu'on souhaite le classement des amis
                                                NetworkImage(value
                                                    .leaderBoardFriends
                                                    .leaderBoardData[index]
                                                        ["PhotoURL"]
                                                    .toString())
                                                : null) //si l'utilisateur possède une photo de profil, on l'affiche, sinon backgroundImage est défini sur null et ne s'affiche pas
                                            : (value.leaderBoardWorld
                                                            .leaderBoardData[index]
                                                        ["PhotoURL"] !=
                                                    null
                                                ? //conditoon si l'utilisateur n'a pas de pp, et qu'on souhaite le classement mondial (selectedIcon=!"friends" donc selectedIcon="world")
                                                NetworkImage(value
                                                    .leaderBoardWorld
                                                    .leaderBoardData[index]
                                                        ["PhotoURL"]
                                        ...
                                        child: selectedIcon == "friends"
                                            ? (value.leaderBoardFriends
                                                        ...
                                                        index]["PhotoURL"] ==
                                                    null
                                                ? //si background image est nul
                                                const Icon(Icons.person,
                                                    size: 40)
                                                : null) // on affiche l'icone par défaut, sinon child est défini sur null et ne s'affiche pas
                                            : (value.leaderBoardWorld
                                                            .leaderBoardData[
                                                        index]["PhotoURL"] ==
                                                    null
                ...
                return SizedBox(
                  child: Text(
                      value.error), //si il y'a une erreur on renvoie l'erreur
                );
              }
            }
          })),
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: selectedIcon == 'world'
                            ...
                            : Colors.transparent, // Fond gris si sélectionné
                        borderRadius:
                            BorderRadius.circular(100), // Bord arrondi
                      ),
                      child: const Icon(
                        Icons.public_rounded,
                        size: 30,
  ...
  Widget buildAffichagePourIndex3() {
    //affichage pour l'index 3
    return Padding(
      padding: const EdgeInsets.fromLTRB(20, 20, 20, 0),
      child: Container(
        width: MediaQuery.of(context).size.width -
            340, //on prend la largeur de la page - la largeur du burger
        decoration: primaryCard,
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.center,
          children: [
