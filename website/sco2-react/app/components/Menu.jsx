 export default function Menu1(){
    return (
            <div className="grid grid-rows-3 grid-flow-col gap-3 bg-[#F9EFDB] pr-4 pt-3 rounded-b-lg h-fit w-fit pb-2">
            <div className="row-span-3"></div>
                <div className="flex col-span-2 w-auto h-fit bg-white shadow-inner border-none rounded items-center justify-center rounded-lg rounded-2xl"><p className="text-5xl text-wrap font-sans pb-2">C'est quoi SCO2 ?</p></div>
                <div className="flex row-span-2 col-span-2 w-fit h-fit bg-[#EBD9B4] shadow-inner border-none rounded-lg rounded-2xl items-center text-justify justify-centerp px-10">
