export default function Menu1() {
    return (
            <div className="grid grid-rows-3 grid-flow-col gap-3 bg-[#F9EFDB] pr-4 pt-3 rounded-b-lg h-auto w-auto">
            <div className="row-span-3"></div>
                ...
                <div className="row-span-2 col-span-2 w-auto h-fit bg-[#EBD9B4] shadow-inner border-none rounded-lg rounded-2xl items-center text-justify justify-centerp px-10">
