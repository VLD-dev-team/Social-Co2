export default function Menu1() {
    return (
            <div className="grid grid-rows-3 grid-flow-col gap-3 bg-[#F9EFDB] pr-4 pt-3 rounded-b-lg h-auto w-fit pb-5">
            <div className="row-span-3"></div>
                <div className="flex col-span-2 w-auto h-auto bg-white shadow-inner border-none rounded items-center justify-center rounded-lg rounded-2xl pb-2"><p className="text-5xl text-wrap font-medium">C'est quoi SCO2 ?</p></div>
                <div className="row-span-2 col-span-2 w-fit h-auto bg-[#EBD9B4] shadow-inner border-none rounded-lg rounded-2xl items-center text-justify justify-centerp px-10">
