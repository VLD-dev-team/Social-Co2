 export default function Menu(){
    return (
            <div className="grid grid-rows-3 grid-flow-col gap-3 bg-orange-100 pr-4 pt-3 rounded-b-lg">
            <div className="row-span-3"></div>
                <div className="flex col-span-2 w-auto h-20 bg-white border-none rounded  items-center justify-center rounded-lg rounded-2xl inner-shadow"><p className="text-5xl font-sans">C'est quoi SCO2 ?</p></div>
                <div className="flex row-span-2 col-span-2 w-auto h-32 bg-orange-200 border-none rounded-lg rounded-2xl items-center text-justify justify-center px-10">
