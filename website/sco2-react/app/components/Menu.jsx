export default function Menu1() {
    return (
            ...
            <div className="row-span-3"></div>
                <div className="flex col-span-2 w-auto h-auto bg-white shadow-inner border-none rounded items-center justify-center rounded-lg rounded-2xl"><p className="text-5xl text-wrap font-sans">C'est quoi SCO2 ?</p></div>
