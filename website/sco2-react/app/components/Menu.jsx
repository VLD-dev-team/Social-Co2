 export default function Menu1(){
    return (
            <div className="grid grid-rows-3 grid-flow-col gap-3 bg-[#F9EFDB] pr-4 pt-3 rounded-b-lg h-auto w-auto pb-5">
            <div className="row-span-3"></div>
                <div className="flex col-span-2 w-auto h-auto bg-white border-none rounded items-center justify-center rounded-lg rounded-2xl pb-3"><p className="text-5xl font-sans">C'est quoi SCO2 ?</p></div>
